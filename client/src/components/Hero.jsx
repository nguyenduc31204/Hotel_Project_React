...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-cover bg-no-repeat bg-center h-screen'>
      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>Giới Hạn Khách Sạn....</p>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Assumenda rem sapiente quis a, expedita doloribus sit, enim temporibus adipisci impedit atque debitis</p>
